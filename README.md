...
- [x] kde on [wayland](https://wayland.freedesktop.org/): supports multiple monitors slightly better, but not stable and compatible enough, maybe wait for 24.04 LTS
