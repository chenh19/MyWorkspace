...
# install apps (apt)
  ...
  sudo apt-get install bash-completion systemd-timesyncd ufw plasma-firewall default-jre default-jdk seahorse tree samba thunderbird kdocker krita krita-l10n inkscape kdenlive libavcodec-extra vlc plymouth-themes solaar -y
