...
# install apps (apt)
  ...
  sudo apt install default-jre default-jdk pkexec systemd-timesyncd ufw needrestart seahorse tree plymouth-themes solaar ttf-mscorefonts-installer thunderbird krita krita-l10n inkscape kdenlive vlc -y
