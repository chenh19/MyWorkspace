...
kwriteconfig6 --file ~/.config/mimeapps.list --group 'Added Associations' --key 'text/csv'  --type string "libreoffice-calc.desktop;org.kde.kwrite.desktop;org.kde.kate.desktop;sqlitebrowser.desktop;"
...
kwriteconfig6 --file ~/.config/mimeapps.list --group 'Default Applications' --key 'text/csv'  --type string "libreoffice-calc.desktop;"
